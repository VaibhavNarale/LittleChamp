...
<template>
  ...
  <!--======== Core Features Grid ========-->
  <section class="space-bottom mt-8">
    <div class="container">
      <div class="row gy-40">
...
.teacher-feature-card:hover .icon-badge {
  transform: scale(1.1);
}
