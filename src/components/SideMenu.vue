<template>
  <div class="sidemenu-wrapper" :class="{ 'show': show }">
      ...
      <div class="widget footer-widget">
        ...
        <div class="recent-post-wrap">
          <div class="recent-post">
            <div class="media-img">
              <router-link to="/blog-details" @click="$emit('close')">
                <img src="/assets/img/blog/blog-thumb-1.jpg" alt="Blog Image">
              </router-link>
            </div>
            <div class="media-body">
              <div class="recent-post-meta">
                <router-link to="/blog" @click="$emit('close')"><i class="fal fa-calendar-alt"></i> 25th March, 2024</router-link>
              </div>
              <h4 class="post-title">
                <router-link to="/blog-details" @click="$emit('close')">User's Pepare Using Story Guide Yes</router-link>
              </h4>
            </div>
          </div>
          <div class="recent-post">
            <div class="media-img">
              <router-link to="/blog-details" @click="$emit('close')">
                <img src="/assets/img/blog/blog-thumb-2.jpg" alt="Blog Image">
              </router-link>
            </div>
            <div class="media-body">
              <div class="recent-post-meta">
              ...
              <h4 class="post-title">
                <router-link to="/blog-details" @click="$emit('close')">How to prepare child for examination</router-link>
              </h4>
            </div>
          </div>
        </div>
